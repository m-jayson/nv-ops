...
import com.mt.route.RouteService.Wrapper;
...
public class RoutePickupService {
  ...
  public Uni<Void> handlePickUp (Map.Entry<String, List<Wrapper>> groupedWrappers, LocalDate date) {

    var jobIds = groupedWrappers.getValue().stream().map(Wrapper::getJobId).toList();
